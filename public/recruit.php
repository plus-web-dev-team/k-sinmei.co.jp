...
$to = "yamauchi-t@plus-agc.com,mi-yu@k-sinmei.co.jp";
			...
			<div class="recruit-thanks-inner">
				<div class="recruit-thanks-header">
					<picture>
						...
						<img src="../_astro/recruit_top.dftmNA05_Z1PMiqB.jpg" alt="採用情報 トップ画像" width="5464" height="3368" loading="lazy" decoding="async">
					</picture>
				</div>
